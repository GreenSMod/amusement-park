...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Пока Выборка.Следующий() Цикл
		...
		ДвиженияАктивныеПосещения = Движения.АктивныеПосещения.Добавить();
		ДвиженияАктивныеПосещения.Период = Дата;
		ДвиженияАктивныеПосещения.ВидДвижения = ВидДвиженияНакопления.Приход;
		ДвиженияАктивныеПосещения.Основание = Ссылка;
		ДвиженияАктивныеПосещения.ВидАттракциона = Выборка.ВидАттракциона;
		ДвиженияАктивныеПосещения.КоличествоПосещений = Выборка.КоличествоПосещений;
